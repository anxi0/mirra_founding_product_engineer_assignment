  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        {others.map(p => (
          <button key={p.id} className="flex items-center gap-3 p-3 rounded-xl border border-gray-200 bg-white hover:border-blue-400 transition-all text-sm">
            <div className={`w-8 h-8 rounded-full bg-gradient-to-br ${p.color} flex items-center justify-center`}>{p.emoji}</div>
